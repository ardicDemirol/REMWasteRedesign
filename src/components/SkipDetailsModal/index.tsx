  ...
  return (
    <>
      ...
      <div
        ...
        onClick={onClose} // overlay'e tıklanınca kapansın
      >
        <div
        ...
        >
          ...
          {/* FOTOĞRAF EN ÜSTTE */}
          <div className="w-full aspect-[2/1] min-h-[120px] max-h-[300px] bg-black rounded-t-2xl overflow-hidden flex items-center justify-center">
            <img
              src={skip.image}
          ...
          <div className="p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button
                onClick={onClose}
                className={`px-6 py-4 border-2 rounded-xl font-bold transition flex-1 text-white ${
                  darkMode
                    ? "border-gray-600 hover:bg-gray-700"
                    : "border-gray-300 bg-gray-900 hover:bg-gray-50 hover:text-black text-white"
                }`}
